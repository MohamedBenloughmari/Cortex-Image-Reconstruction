...
class NeuralEncoder:
    ...
    def decode(self, D, mean_offset=0.0, n_particles=80, n_samples=30,
               ...
               anchor_weight=1.0, anchor_decay=0.9, verbose=True):
        ...
        cur_anchor_w = 0.0  # no anchor at t=0
        for t in range(T):
            if t > 0:
            ...
            cur_anchor_w = anchor_weight + anchor_decay * cur_anchor_w  # accumulates like 1/Hessian forgetting
...
if __name__ == "__main__":
    ...
    sim.decode(D, mean_offset=mean_offset,
               ...
               beta=1e-2, gamma=1.0,
               adam_iter=30, lr=1e-3,
               anchor_weight=0.5, anchor_decay=0.9)
